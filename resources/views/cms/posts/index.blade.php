...
@section('page-name-small','All posts')
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-muted mt-3 font-weight-bold font-size-sm">Manage posts</span>
            </h3>

            <div class="card-toolbar">
                <a href="{{route('posts.create')}}" class="btn btn-info font-weight-bolder font-size-sm">New
                    posts</a>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <img class="img-circle img-bordered-sm" width="65" height="65"
                                     src="{{url(Storage::url($post->image ?? ''))}}"  alt="User Image">
                            </td>
                            <td>{{$post->title ?? ''}}</td>
                            ...
                            <td class="pr-0 text-right">
                                ...
                                <a href="#" onclick="confirmDestroy('{{$post->id}}',this)"
...
@section('scripts')
    ...
    <script>
        ...
        function destroy(id, reference) {
            //JS - Axios
            axios.delete('/admin/dashboard/posts/'+id)
